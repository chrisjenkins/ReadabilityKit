...
struct DomainRuleRegistry: Sendable {
    ...
    static let customGeneratedRules: [any DomainExtractionRule] = [
        ...
        BBCNewsArticlesDomainExtractionRule(),
        ...
        SupportAppleComDomainExtractionRule(),
        ...
        SandiegouniontribuneComCustomDomainExtractionRule(),
        ...
        VultureComCustomDomainExtractionRule(),
